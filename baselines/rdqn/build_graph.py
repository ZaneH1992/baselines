...
def build_act(make_obs_ph, q_func, num_actions, scope="rdqn", reuse=None):
...
def build_act_with_param_noise(make_obs_ph, q_func, num_actions, scope="rdqn", reuse=None, param_noise_filter_func=None):
...
def build_train(make_obs_ph, q_func, num_actions, optimizer, grad_norm_clipping=None, gamma=1.0,
    double_q=True, scope="rdqn", reuse=None, param_noise=False, param_noise_filter_func=None):
